    		...
    		<div role="tabpanel" class="tab-pane active" id="rlibro">        
        		<div class="form-group col-xs-6 col-xs-offset-3">
         			<table class="table table-bordered">
         				...
         				<form action="actulibro.php" method="POST">

         				<div class="col-xs-12 text-center h4">Titulo del Libro:<input type="text" name="titulo" class="form-control" required="" value="<?php echo $titulo ?>"></div>

			            <div class="col-xs-12 text-center h4">Autor(es):<input class="form-control" type="text" name="autor" required=""  value="<?php echo $autor ?>"></div>

			            <div class="col-xs-12 text-center h4">Código del Libro:<input class="form-control" type="number" name="codigo" required=""   value="<?php echo $codigo ?>" ></div>

			            <div class="col-xs-12 text-center h4">Editorial:<input class="form-control" type="text" name="editorial"  required="" value="<?php echo $editorial ?>"></div>

			            <div class="col-xs-6 text-center h4">Fecha de Edición<input class="form-control" type="date" name="anio" required="" value="<?php echo $anio ?>"></div>

			            <div class="col-xs-6 text-center h4">Volumenes<input class="form-control" type="number" name="volumen" required=""  value="<?php echo $volumen ?>"></div> 

			            <div class="col-xs-6 text-center h4">Clasificación por sala: 
			                    <select name="clasificacion" type="text" class="form-control">
			                        <option value="<?php echo $clasificacion ?>" disabled="">Selecione la Sala</option>
			            ...
			            <div class="col-xs-6 text-center h4">Cantidad en Existencia<input class="form-control" type="text" name="cantidad" required="" value="<?php echo $cantidad ?>"></div>
			            
			           
			   		    <div><button type="submit" class="miboton3 col-xs-6">actualizar <span class="glyphicon glyphicon-refresh"></span></button></a></div>

						</form>
		            	<div><a href="codigo.html"><button type="submit" class="miboton2 col-xs-6">Buscar otro Libro <span class="glyphicon glyphicon-search"></span></button></a></div>
