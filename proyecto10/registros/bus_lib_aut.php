    		...
    		<div role="tabpanel" class="tab-pane active" id="rlibro">        
        		<div class="form-group col-xs-6 col-xs-offset-3">
         			<table class="table table-bordered">
		            	...
		            	<div><a href="autor.html"><button type="submit" class="miboton2 col-xs-12">Buscar otro Libro <span class="glyphicon glyphicon-search"></span></button></a></div>
