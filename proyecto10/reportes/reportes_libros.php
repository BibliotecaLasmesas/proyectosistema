...
<center><div class="col-xs- 12 text-cal-1 text-desing">Inventario de Libros</div></center>

<header>
<?php
    include ('../lib/funciones.php');
    $conexion=conexion();
    $consulta = mysql_query("SELECT * FROM libros ORDER BY titulo ASC", $conexion);
    ?>
</header>
 <table class="table table-hover col-xs-12 text-center">
    <tr class="table info">
	    ...
	    <th class="text-center">Año de Publicacìón</th>
